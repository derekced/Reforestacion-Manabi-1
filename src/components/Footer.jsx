        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold">{t('footer.titulo')}</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/proyectos" className="text-green-100 hover:text-green-400 transition-colors text-sm">
                  {t('sidebar.proyectos')}
                </a>
              </li>
          ...
          {/* Contacto */}
          <div>
            <h3 className="text-lg font-bold mb-4">{t('footer.contacto')}</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-green-100 text-sm">
                ...
                <a href="mailto:info@reforestacionmanabi.org" className="hover:text-green-400 transition-colors">
                  info@reforestacionmanabi.org
                </a>
              </li>
              <li className="flex items-center gap-2 text-green-100 text-sm">
                <Phone className="w-4 h-4 shrink-0 text-green-400" />
                <a href="tel:+593987654321" className="hover:text-green-400 transition-colors">
                  +593 98 765 4321
                </a>
              </li>
            </ul>
          ...
          {/* Redes sociales */}
          <div>
            <h3 className="text-lg font-bold mb-4">{t('footer.siguenos')}</h3>
            <p className="text-green-100 text-sm mb-4">
              {t('footer.redesSociales')}
            </p>
